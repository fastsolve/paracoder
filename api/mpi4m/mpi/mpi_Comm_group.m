function [group, info, toplevel] = mpi_Comm_group(comm)
...
%
% C interface:
% int MPI_Comm_group(MPI_Comm comm, MPI_Comm *group)
% http://mpi.deino.net/mpi_functions/MPI_Comm_group.html

%#codegen -args {MPI_Comm}

info = int32(0); %#ok<NASGU>
group0 = coder.opaque('MPI_Group');
info = coder.ceval('MPI_Comm_group', MPI_Comm(comm), coder.wref(group0));
