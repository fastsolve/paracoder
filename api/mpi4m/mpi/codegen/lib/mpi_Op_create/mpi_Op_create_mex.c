/*
 * mpi/codegen/lib/mpi_Op_create/mpi_Op_create_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Op_create
 *
 * C source code generated by m2c.
 * %#m2c options:5e94aef3502f6f49d5de183ed0d49057
 *
 */
...
static void __mpi_Op_create_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       func;
    int32_T              commute;
    M2C_OpaqueType       op;
    int32_T             *info;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Op_create:WrongInputType",
            "Input argument func has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Op_create:WrongSizeOfInputArg",
            "Argument func should be a scalar.");
    marshallin_const_M2C_OpaqueType(&func, prhs[0], "func");

    if (mxGetNumberOfElements(prhs[1]) && mxGetClassID(prhs[1]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mpi_Op_create:WrongInputType",
            "Input argument commute has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[1]) != 1)
        mexErrMsgIdAndTxt("mpi_Op_create:WrongSizeOfInputArg",
            "Argument commute should be a scalar.");
    commute = *(int32_T*)mxGetData(prhs[1]);
    prealloc_M2C_OpaqueType(&op);
    ...
    mpi_Op_create(&func, commute, &op, info, toplevel);

    /* Deallocate input and marshall out function outputs */
    destroy_M2C_OpaqueType(&func);
    /* Nothing to be done for commute */
    plhs[0] = marshallout_M2C_OpaqueType(&op);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Op_create:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Op_create.\n");
        /* Call the API function. */
        __mpi_Op_create_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Op_create:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Op_create.");
