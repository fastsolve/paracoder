...
static void b_m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("MPI:RuntimeError",
            "MPI_Type_create_indexed_block failed with error message %s\n",
            &b_varargin_3->data[0]);
...
void mpi_Type_create_indexed_block(int count, int blocklen,
                                   ...
                                   boolean_T *toplevel)
{
  ...
  *info = MPI_Type_create_indexed_block(count, blocklen, &indices->data[0],
                                        datatype, &arg);
...
void mpi_Type_create_indexed_block_initialize(void)
{
}

void mpi_Type_create_indexed_block_terminate(void)
{
}
