...
void mpi_Cart_get(const M2C_OpaqueType *comm, int maxdims, emxArray_int32_T
                  *dims, emxArray_int32_T *periods, emxArray_int32_T *coords,
                  int *info, boolean_T *toplevel)
{
  ...
  emxEnsureCapacity_int32_T(periods, i);
  for (i = 0; i < maxdims; i++) {
    periods->data[i] = 0;
  }
