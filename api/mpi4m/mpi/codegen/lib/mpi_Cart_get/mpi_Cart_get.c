                  ...
                  boolean_T *toplevel)
{
  ...
  i0 = dims->size[0];
  dims->size[0] = maxdims;
  emxEnsureCapacity((emxArray__common *)dims, i0, (int)sizeof(int));
  for (i0 = 0; i0 < maxdims; i0++) {
    dims->data[i0] = 0;
  }

  i0 = periods->size[0];
  periods->size[0] = maxdims;
  emxEnsureCapacity((emxArray__common *)periods, i0, (int)sizeof(int));
  for (i0 = 0; i0 < maxdims; i0++) {
    periods->data[i0] = 0;
  }
  ...
  emxEnsureCapacity((emxArray__common *)coords, i0, (int)sizeof(int));
  for (i0 = 0; i0 < maxdims; i0++) {
    coords->data[i0] = 0;
  }
