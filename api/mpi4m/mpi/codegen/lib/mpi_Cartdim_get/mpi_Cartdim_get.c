...
static void b_m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("MPI:RuntimeError",
            "MPI_Cartdim_get failed with error message %s\n",
            &b_varargin_3->data[0]);
                     ...
                     boolean_T *toplevel)
{
  ...
  *info = MPI_Cartdim_get(c_comm, ndims);
  *toplevel = true;
  if (*info != 0) {
...
void mpi_Cartdim_get_initialize(void)
{
}

void mpi_Cartdim_get_terminate(void)
{
}
