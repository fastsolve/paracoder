/*
 * mpi/codegen/lib/mpi_Group_incl/mpi_Group_incl_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Group_incl
 *
...
static void __mpi_Group_incl_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       group;
    int32_T              n;
    emxArray_int32_T     ranks;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Group_incl:WrongInputType",
            "Input argument group has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Group_incl:WrongSizeOfInputArg",
    ...
    if (mxGetNumberOfElements(prhs[2]) && mxGetClassID(prhs[2]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mpi_Group_incl:WrongInputType",
            "Input argument ranks has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[2]) && mxGetDimensions(prhs[2])[1] != 1) 
        mexErrMsgIdAndTxt("mpi_Group_incl:WrongSizeOfInputArg",
            "Dimension 2 of ranks should be equal to 1.");
    alias_mxArray_to_emxArray(prhs[2], (emxArray__common *)(&ranks), "ranks", 1);
    ...
    mpi_Group_incl(&group, n, &ranks, &newgroup, info, toplevel);

    /* Deallocate input and marshall out function outputs */
    destroy_M2C_OpaqueType(&group);
    /* Nothing to be done for n */
    free_emxArray((emxArray__common*)(&ranks));
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 3) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Group_incl:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Group_incl.\n");
        /* Call the API function. */
        __mpi_Group_incl_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Group_incl:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Group_incl.");
