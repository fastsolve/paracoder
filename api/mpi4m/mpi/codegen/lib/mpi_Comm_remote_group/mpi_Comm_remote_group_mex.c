/*
 * mpi/codegen/lib/mpi_Comm_remote_group/mpi_Comm_remote_group_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Comm_remote_group
 *
...
static void __mpi_Comm_remote_group_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       comm;
    ...
    mpi_Comm_remote_group(&comm, &group, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Comm_remote_group:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Comm_remote_group.\n");
        /* Call the API function. */
        __mpi_Comm_remote_group_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Comm_remote_group:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Comm_remote_group.");
