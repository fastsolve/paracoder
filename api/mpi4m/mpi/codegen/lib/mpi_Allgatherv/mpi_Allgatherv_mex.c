/*
 * mpi/codegen/lib/mpi_Allgatherv/mpi_Allgatherv_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Allgatherv
 *
 * C source code generated by m2c.
 * %#m2c options:2871000539a6859bb36a1a22900511dc
 *
 */
...
static void __mpi_Allgatherv_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Allgatherv:WrongInputType",
            "Input argument sptr has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Allgatherv:WrongSizeOfInputArg",
    ...
    alias_mxArray_to_emxArray(prhs[4], (emxArray__common *)(&rcounts), "rcounts", 2);
    ...
    alias_mxArray_to_emxArray(prhs[5], (emxArray__common *)(&disps), "disps", 2);
    ...
    marshallin_const_M2C_OpaqueType(&rtype, prhs[6], "rtype");
    ...
    mpi_Allgatherv(&sptr, scount, &stype, &rptr, &rcounts, &disps, &rtype, &comm, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 8) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("mpi_Allgatherv:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Allgatherv.\n");
        /* Call the API function. */
        __mpi_Allgatherv_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Allgatherv:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Allgatherv.");
