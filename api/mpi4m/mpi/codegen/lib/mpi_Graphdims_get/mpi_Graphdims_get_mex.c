/*
 * mpi/codegen/lib/mpi_Graphdims_get/mpi_Graphdims_get_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Graphdims_get
 *
 * C source code generated by m2c.
 * %#m2c options:631078427f54841a66c17958c294e6c0
 *
 */
...
static void __mpi_Graphdims_get_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            comm;
    int32_T             *nnodes;
    int32_T             *nedges;
    int32_T             *info;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Graphdims_get:WrongInputType",
            "Input argument comm has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Graphdims_get:WrongSizeOfInputArg",
            "Argument comm should be a scalar.");
    marshallin_const_struct0_T(&comm, prhs[0], "comm");

    nnodes = (int32_T*)mxMalloc(sizeof(int32_T));

    nedges = (int32_T*)mxMalloc(sizeof(int32_T));
    ...
    mpi_Graphdims_get(&comm, nnodes, nedges, info, toplevel);

    /* Deallocate input and marshall out function outputs */
    destroy_struct0_T(&comm);
    plhs[0] = move_scalar_to_mxArray(nnodes, mxINT32_CLASS);
    plhs[1] = move_scalar_to_mxArray(nedges, mxINT32_CLASS);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("mpi_Graphdims_get:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Graphdims_get.\n");
        /* Call the API function. */
        __mpi_Graphdims_get_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Graphdims_get:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Graphdims_get.");
