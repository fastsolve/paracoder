...
static void __mpi_Type_get_extent_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    marshallin_const_struct0_T(&datatype, prhs[0], "datatype");
    prealloc_struct0_T(&lb);
    prealloc_struct0_T(&extent);
    ...
    plhs[0] = marshallout_struct0_T(&lb);
    plhs[1] = marshallout_struct0_T(&extent);
