  ...
  int *info, boolean_T *toplevel)
{
  ...
  do {
    exitg2 = 0;
    if (resultlen < 2) {
      i0 = errhandler->type->size[resultlen];
      if (i0 != 13 * resultlen + 1) {
        exitg2 = 1;
      } else {
        resultlen++;
      }
  ...
  if (!p) {
    ...
    i0 = b_errhandler->size[0] * b_errhandler->size[1];
    b_errhandler->size[0] = 1;
    b_errhandler->size[1] = errhandler->type->size[1] + 1;
    emxEnsureCapacity((emxArray__common *)b_errhandler, i0, (int)sizeof(char));
    resultlen = errhandler->type->size[1];
    for (i0 = 0; i0 < resultlen; i0++) {
      b_errhandler->data[b_errhandler->size[0] * i0] = errhandler->type->
        data[errhandler->type->size[0] * i0];
    }
  ...
  for (i0 = 0; i0 < resultlen; i0++) {
    data->data[i0] = errhandler->data->data[i0];
  }
