...
void mpi_Testall(int count, struct0_T *reqs, int *flag, struct0_T *stats, int
                 *info, boolean_T *toplevel)
{
  ...
  *info = MPI_Testall(count, ptr, flag, b_ptr);
  *toplevel = true;
...
void mpi_Testall_initialize(void)
{
}

void mpi_Testall_terminate(void)
{
}
