/*
 * mpi/codegen/lib/mpi_Bcast/mpi_Bcast_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Bcast
 *
 * C source code generated by m2c.
 * %#m2c options:6fa18f0cfef11f9b5c1a4b8fe2597be4
 *
 */
...
static void __mpi_Bcast_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Bcast:WrongInputType",
            "Input argument ptr has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Bcast:WrongSizeOfInputArg",
    ...
    marshallin_const_M2C_OpaqueType(&comm, prhs[4], "comm");
    ...
    mpi_Bcast(&ptr, count, &datatype, root, &comm, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 5) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("mpi_Bcast:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Bcast.\n");
        /* Call the API function. */
        __mpi_Bcast_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Bcast:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Bcast.");
