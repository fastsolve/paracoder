/*
 * mpi/codegen/lib/mpi_Test_cancelled/mpi_Test_cancelled_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Test_cancelled
 *
 * C source code generated by m2c.
 * %#m2c options:133ea446f7c635d8b55ab9dc8503128e
 *
 */
...
static void __mpi_Test_cancelled_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       stat;
    int32_T             *flag;
    int32_T             *info;
    boolean_T           *toplevel;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Test_cancelled:WrongInputType",
            "Input argument stat has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Test_cancelled:WrongSizeOfInputArg",
    ...
    mpi_Test_cancelled(&stat, flag, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Test_cancelled:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Test_cancelled.\n");
        /* Call the API function. */
        __mpi_Test_cancelled_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Test_cancelled:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Test_cancelled.");
