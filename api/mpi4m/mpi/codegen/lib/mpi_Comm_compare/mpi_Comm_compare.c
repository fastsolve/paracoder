                      ...
                      *result, int *info, boolean_T *toplevel)
{
  ...
  if (!p) {
    ...
    emxEnsureCapacity((emxArray__common *)b_comm1, resultlen, sizeof(char));
  ...
  if (!p) {
    ...
    resultlen = b_comm2->size[0] * b_comm2->size[1];
    b_comm2->size[0] = 1;
    b_comm2->size[1] = comm2->type->size[1] + 1;
    emxEnsureCapacity((emxArray__common *)b_comm2, resultlen, sizeof(char));
    loop_ub = comm2->type->size[1];
    for (resultlen = 0; resultlen < loop_ub; resultlen++) {
      b_comm2->data[b_comm2->size[0] * resultlen] = comm2->type->data
