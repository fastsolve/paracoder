/*
 * mpi/codegen/lib/mpi_Group_intersection/mpi_Group_intersection_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Group_intersection
 *
...
static void __mpi_Group_intersection_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Group_intersection:WrongInputType",
            "Input argument group1 has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Group_intersection:WrongSizeOfInputArg",
    ...
    marshallin_const_M2C_OpaqueType(&group2, prhs[1], "group2");
    ...
    mpi_Group_intersection(&group1, &group2, &newgroup, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Group_intersection:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Group_intersection.\n");
        /* Call the API function. */
        __mpi_Group_intersection_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Group_intersection:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Group_intersection.");
