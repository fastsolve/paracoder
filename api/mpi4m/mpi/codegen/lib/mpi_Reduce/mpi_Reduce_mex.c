/*
 * mpi/codegen/lib/mpi_Reduce/mpi_Reduce_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Reduce
 *
 * C source code generated by m2c.
 * %#m2c options:9a94ff32cd461323baeb36f8f85000da
 *
 */
...
static void __mpi_Reduce_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Reduce:WrongInputType",
            "Input argument sptr has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Reduce:WrongSizeOfInputArg",
    ...
    marshallin_const_M2C_OpaquePtrType(&rptr, prhs[1], "rptr");
    ...
    count = *(int32_T*)mxGetData(prhs[2]);
    ...
    marshallin_const_M2C_OpaqueType(&datatype, prhs[3], "datatype");
    ...
    marshallin_const_M2C_OpaqueType(&op, prhs[4], "op");
    ...
    mpi_Reduce(&sptr, &rptr, count, &datatype, &op, root, &comm, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 7) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("mpi_Reduce:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Reduce.\n");
        /* Call the API function. */
        __mpi_Reduce_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Reduce:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Reduce.");
