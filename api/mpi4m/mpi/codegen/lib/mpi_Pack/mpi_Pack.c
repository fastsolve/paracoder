...
void mpi_Pack(const M2C_OpaquePtrType *inbuf, int incount, const M2C_OpaqueType *
              datatype, const M2C_OpaquePtrType *outbuf, int outcount, int
              *position, const M2C_OpaqueType *comm, int *info, boolean_T
              *toplevel)
{
  boolean_T p;
  int resultlen;
