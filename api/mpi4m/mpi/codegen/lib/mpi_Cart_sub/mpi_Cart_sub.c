...
void mpi_Cart_sub(const M2C_OpaqueType *comm, const emxArray_int32_T
                  *remain_dims, M2C_OpaqueType *newcomm, int *info, boolean_T
                  *toplevel)
{
  boolean_T p;
  int sizepe;
  ...
  *info = MPI_Cart_sub(c_comm, &remain_dims->data[0], &arg);
...
void mpi_Cart_sub_initialize(void)
{
}

void mpi_Cart_sub_terminate(void)
{
}
