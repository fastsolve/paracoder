...
void mpi_Sendrecv_replace(const M2C_OpaquePtrType *ptr, int count,
                          const M2C_OpaqueType *datatype, int dst, int stag,
                          int src, int rtag, const M2C_OpaqueType *comm,
                          M2C_OpaqueType *stat, int *info, boolean_T *toplevel)
{
  static const char cv[12] = {'M', 'P', 'I', '_', 'D', 'a',
                              't', 'a', 't', 'y', 'p', 'e'};
  static const char cv3[10] = {'M', 'P', 'I', '_', 'S',
                               't', 'a', 't', 'u', 's'};
