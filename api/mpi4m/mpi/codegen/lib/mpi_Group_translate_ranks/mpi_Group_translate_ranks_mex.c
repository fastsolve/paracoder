...
static void __mpi_Group_translate_ranks_api(mxArray **plhs, const mxArray ** prhs) {
    M2C_OpaqueType       group1;
    int32_T              n;
    emxArray_int32_T     ranks1;
    M2C_OpaqueType       group2;
    ...
    marshallin_const_M2C_OpaqueType(&group1, prhs[0], "group1");
    ...
    if (mxGetNumberOfElements(prhs[2]) && mxGetDimensions(prhs[2])[1] != 1) 
        mexErrMsgIdAndTxt("mpi_Group_translate_ranks:WrongSizeOfInputArg",
            "Dimension 2 of ranks1 should be equal to 1.");
    ...
    marshallin_const_M2C_OpaqueType(&group2, prhs[3], "group2");
