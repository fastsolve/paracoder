...
void mpi_Pack_size(int count, const M2C_OpaqueType *datatype,
                   ...
                   boolean_T *toplevel)
{
  ...
  *info = MPI_Pack_size(count, c_datatype, b_comm, size);
  *toplevel = true;
  if (*info != 0) {
...
void mpi_Pack_size_initialize(void)
{
}

void mpi_Pack_size_terminate(void)
{
}
