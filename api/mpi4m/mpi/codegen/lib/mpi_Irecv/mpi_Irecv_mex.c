/*
 * mpi/codegen/lib/mpi_Irecv/mpi_Irecv_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Irecv
 *
 * C source code generated by m2c.
 * %#m2c options:575f8ede2de6f4496f05e35b5c1836bc
 *
 */
...
static void __mpi_Irecv_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Irecv:WrongInputType",
            "Input argument ptr has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Irecv:WrongSizeOfInputArg",
    ...
    mpi_Irecv(&ptr, count, &datatype, src, tag, &comm, &req, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 6) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Irecv:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Irecv.\n");
        /* Call the API function. */
        __mpi_Irecv_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Irecv:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Irecv.");
