...
void mpi_Irecv(const struct0_T *ptr, int count, const struct1_T *datatype, int
               src, int tag, const struct1_T *comm, struct1_T *req, int *info,
               boolean_T *toplevel)
{
  ...
  *info = MPI_Irecv(b_ptr, count, c_datatype, src, tag, c_comm, &req0);
  *toplevel = true;
...
void mpi_Irecv_initialize(void)
{
}

void mpi_Irecv_terminate(void)
{
}
