/*
 * mpi/codegen/lib/mpi_Type_vector/mpi_Type_vector_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Type_vector
 *
 * C source code generated by m2c.
 * %#m2c options:87a3ffea1fd7c5540047070a92c74b0a
 *
 */
...
static void __mpi_Type_vector_api(mxArray **plhs, const mxArray ** prhs) {
    int32_T              count;
    int32_T              blocklen;
    int32_T              stride;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mpi_Type_vector:WrongInputType",
            "Input argument count has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Type_vector:WrongSizeOfInputArg",
    ...
    if (mxGetNumberOfElements(prhs[2]) && mxGetClassID(prhs[2]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mpi_Type_vector:WrongInputType",
            "Input argument stride has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[2]) != 1)
        mexErrMsgIdAndTxt("mpi_Type_vector:WrongSizeOfInputArg",
            "Argument stride should be a scalar.");
    stride = *(int32_T*)mxGetData(prhs[2]);
    ...
    mpi_Type_vector(count, blocklen, stride, &oldtype, &newtype, info, toplevel);

    /* Deallocate input and marshall out function outputs */
    /* Nothing to be done for count */
    /* Nothing to be done for blocklen */
    /* Nothing to be done for stride */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 4) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Type_vector:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Type_vector.\n");
        /* Call the API function. */
        __mpi_Type_vector_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Type_vector:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Type_vector.");
