...
static void b_m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("MPI:RuntimeError",
            "MPI_Type_contiguous failed with error message %s\n",
            &b_varargin_3->data[0]);
...
void mpi_Type_contiguous(int count, const struct0_T *oldtype, struct0_T *newtype,
  int *info, boolean_T *toplevel)
{
  ...
  *info = MPI_Type_contiguous(count, datatype, &newtype0);
  *toplevel = true;
...
void mpi_Type_contiguous_initialize(void)
{
}

void mpi_Type_contiguous_terminate(void)
{
}
