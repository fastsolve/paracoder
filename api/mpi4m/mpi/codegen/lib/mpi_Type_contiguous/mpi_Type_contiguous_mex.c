/*
 * mpi/codegen/lib/mpi_Type_contiguous/mpi_Type_contiguous_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Type_contiguous
 *
 * C source code generated by m2c.
 * %#m2c options:fe123ab54e53914ff0e930894bd68f45
 *
 */
...
static void __mpi_Type_contiguous_api(mxArray **plhs, const mxArray ** prhs) {
    int32_T              count;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mpi_Type_contiguous:WrongInputType",
            "Input argument count has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Type_contiguous:WrongSizeOfInputArg",
    ...
    marshallin_const_M2C_OpaqueType(&oldtype, prhs[1], "oldtype");
    ...
    mpi_Type_contiguous(count, &oldtype, &newtype, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Type_contiguous:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Type_contiguous.\n");
        /* Call the API function. */
        __mpi_Type_contiguous_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Type_contiguous:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Type_contiguous.");
