...
void mpi_Isend(const M2C_OpaquePtrType *ptr, int count, const M2C_OpaqueType
               ...
               M2C_OpaqueType *req, int *info, boolean_T *toplevel)
{
  ...
  *info = MPI_Isend(b_ptr, count, c_datatype, dest, tag, b_comm, &arg);
...
void mpi_Isend_initialize(void)
{
}

void mpi_Isend_terminate(void)
{
}
