...
static void b_m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("MPI:RuntimeError",
            "MPI_Group_union failed with error message %s\n",
            &b_varargin_3->data[0]);
...
void mpi_Group_union(const M2C_OpaqueType *group1, const M2C_OpaqueType *group2,
                     M2C_OpaqueType *newgroup, int *info, boolean_T *toplevel)
{
  MPI_Group arg;
  MPI_Group b_obj;
  MPI_Group obj;
  ...
  *info = MPI_Group_union(obj, b_obj, &arg);
...
void mpi_Group_union_initialize(void)
{
}

void mpi_Group_union_terminate(void)
{
}
