...
void mpi_Group_union(const struct0_T *group1, const struct0_T *group2, struct0_T
                     *newgroup, int *info, boolean_T *toplevel)
{
  MPI_Group newgroup0;
  boolean_T p;
  boolean_T b_p;
  ...
  *info = MPI_Group_union(obj, b_obj, &newgroup0);
  *toplevel = true;
