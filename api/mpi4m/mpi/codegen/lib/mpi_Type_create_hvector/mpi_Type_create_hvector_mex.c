/*
 * mpi/codegen/lib/mpi_Type_create_hvector/mpi_Type_create_hvector_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Type_create_hvector
 *
 * C source code generated by m2c.
 * %#m2c options:6a9b9927e14a9ce5881537bdc5981cff
 *
 */
...
static void __mpi_Type_create_hvector_api(mxArray **plhs, const mxArray ** prhs) {
    int32_T              count;
    int32_T              blocklen;
    M2C_OpaqueType       stride;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("mpi_Type_create_hvector:WrongInputType",
            "Input argument count has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Type_create_hvector:WrongSizeOfInputArg",
    ...
    if (mxGetNumberOfElements(prhs[2]) && mxGetClassID(prhs[2]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Type_create_hvector:WrongInputType",
            "Input argument stride has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[2]) != 1)
        mexErrMsgIdAndTxt("mpi_Type_create_hvector:WrongSizeOfInputArg",
            "Argument stride should be a scalar.");
    marshallin_const_M2C_OpaqueType(&stride, prhs[2], "stride");
    ...
    mpi_Type_create_hvector(count, blocklen, &stride, &oldtype, &newtype, info, toplevel);

    /* Deallocate input and marshall out function outputs */
    /* Nothing to be done for count */
    /* Nothing to be done for blocklen */
    destroy_M2C_OpaqueType(&stride);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 4) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("mpi_Type_create_hvector:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Type_create_hvector.\n");
        /* Call the API function. */
        __mpi_Type_create_hvector_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Type_create_hvector:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Type_create_hvector.");
