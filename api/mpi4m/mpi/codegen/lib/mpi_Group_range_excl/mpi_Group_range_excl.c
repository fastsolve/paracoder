...
static void c_m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("MPI:RuntimeError",
            "MPI_Group_range_excl failed with error message %s\n",
            &b_varargin_3->data[0]);
  emxFree_char_T(&b_varargin_3);
}
...
void mpi_Group_range_excl(const struct0_T *group, int n, const emxArray_int32_T *
  ranges, struct0_T *newgroup, int *info, boolean_T *toplevel)
{
  ...
  *info = MPI_Group_range_excl(obj, n, ptr, &newgroup0);
...
void mpi_Group_range_excl_initialize(void)
{
}

void mpi_Group_range_excl_terminate(void)
{
}
