...
void mpi_Ssend_init(const M2C_OpaquePtrType *ptr, int count,
                    ...
                    boolean_T *toplevel)
{
  ...
  *info = MPI_Ssend_init(b_ptr, count, c_datatype, dest, tag, b_comm, &arg);
...
void mpi_Ssend_init_initialize(void)
{
}

void mpi_Ssend_init_terminate(void)
{
}
