...
static void b_m2c_error(void)
{
  M2C_error("mpi_Irsend:OutOfBound",
...
void mpi_Irsend(const M2C_OpaquePtrType *ptr, int count, const M2C_OpaqueType
                ...
                M2C_OpaqueType *req, int *info, boolean_T *toplevel)
{
  ...
  *info = MPI_Irsend(b_ptr, count, c_datatype, dest, tag, b_comm, &arg);
...
void mpi_Irsend_initialize(void)
{
}

void mpi_Irsend_terminate(void)
{
}
