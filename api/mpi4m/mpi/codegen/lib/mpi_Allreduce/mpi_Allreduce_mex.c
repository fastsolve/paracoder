/*
 * mpi/codegen/lib/mpi_Allreduce/mpi_Allreduce_mex.c
 *
 * Auxiliary code for mexFunction of mpi_Allreduce
 *
 * C source code generated by m2c.
 * %#m2c options:488fb5288544e56ad279188ff5ecc876
 *
 */
...
static void __mpi_Allreduce_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("mpi_Allreduce:WrongInputType",
            "Input argument sptr has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("mpi_Allreduce:WrongSizeOfInputArg",
    ...
    mpi_Allreduce(&sptr, &rptr, count, &datatype, &op, &comm, info, toplevel);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 6) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("mpi_Allreduce:TooManyOutputArguments",
                "Too many output arguments for entry-point mpi_Allreduce.\n");
        /* Call the API function. */
        __mpi_Allreduce_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("mpi_Allreduce:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point mpi_Allreduce.");
