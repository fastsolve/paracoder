/*
 * crs/codegen/lib/crs_solve_utriu/crs_solve_utriu_mex.c
 *
 * Auxiliary code for mexFunction of crs_solve_utriu
 *
 * C source code generated by m2c.
 * %#m2c options:be6494ec8dd2d57c26c566f309b2bd9e
 *
 */
...
static void __crs_solve_utriu_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           U;
    emxArray_real_T      b;

    /* Marshall in inputs and preallocate outputs */
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("crs_solve_utriu:WrongInputType",
            "Input argument U has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("crs_solve_utriu:WrongSizeOfInputArg",
            "Argument U should be a scalar.");
    marshallin_const_CRS_Matrix(&U, prhs[0], "U");
    ...
    destroy_CRS_Matrix(&U);
    plhs[0] = move_emxArray_to_mxArray((emxArray__common*)(&b), mxDOUBLE_CLASS);
    mxFree(b.size);

}

static void __crs_solve_utriu_3args_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           L;
    emxArray_real_T      b;
    int32_T              offset;
    ...
    /* Marshall in inputs and preallocate outputs */
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("crs_solve_utriu_3args:WrongInputType",
            "Input argument L has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("crs_solve_utriu_3args:WrongSizeOfInputArg",
    ...
    /* Invoke the target function */
    crs_solve_utriu_3args(&L, &b, offset);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    if (nrhs == 2) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_solve_utriu:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_solve_utriu.\n");
        /* Call the API function. */
        __crs_solve_utriu_api(plhs, prhs);
    }
    else if (nrhs == 3) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_solve_utriu_3args:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_solve_utriu_3args.\n");
        /* Call the API function. */
        __crs_solve_utriu_3args_api(plhs, prhs);
    }
    else
        mexErrMsgIdAndTxt("crs_solve_utriu:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point crs_solve_utriu.");
}
