/*
 * crs/codegen/lib/crs_triu/crs_triu_mex.c
 *
 * Auxiliary code for mexFunction of crs_triu
 *
 * C source code generated by m2c.
 * %#m2c options:b15070af9fc24a937631a85e42881ebe
 *
 */
...
static void __crs_triu_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           A;
    CRS_Matrix           U;
    ...
    plhs[0] = marshallout_CRS_Matrix(&U);

}

static void __crs_triu1_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           A;
    int32_T              k;
    CRS_Matrix           U;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    if (nrhs == 1) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_triu:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_triu.\n");
        /* Call the API function. */
        __crs_triu_api(plhs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_triu1:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_triu1.\n");
        /* Call the API function. */
        __crs_triu1_api(plhs, prhs);
    }
    else
        mexErrMsgIdAndTxt("crs_triu:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point crs_triu.");
}
