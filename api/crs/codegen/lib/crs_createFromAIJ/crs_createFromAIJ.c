                 ...
                 emxArray_real_T *vs, int ni, int nj, struct0_T *A)
{
  ...
  emxEnsureCapacity_int32_T(A->row_ptr, i1);
  for (i1 = 0; i1 <= ni; i1++) {
    A->row_ptr->data[i1] = 0;
  }
  ...
  emxEnsureCapacity_int32_T(A->col_ind, i1);
  j = (int)unnamed_idx_0;
  for (i1 = 0; i1 < j; i1++) {
    A->col_ind->data[i1] = 0;
  }
  ...
  *cols, const emxArray_real_T *vs, struct0_T *A)
{
  ...
  emxEnsureCapacity_int32_T(A->row_ptr, i0);
  for (i0 = 0; i0 <= mtmp; i0++) {
    A->row_ptr->data[i0] = 0;
  }
  ...
  i0 = A->col_ind->size[0];
  A->col_ind->size[0] = j;
  emxEnsureCapacity_int32_T(A->col_ind, i0);
  for (i0 = 0; i0 < j; i0++) {
    A->col_ind->data[i0] = 0;
  }
