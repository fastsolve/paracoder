/*
 * crs/codegen/lib/crs_prodAAtx/crs_prodAAtx_mex.c
 *
 * Auxiliary code for mexFunction of crs_prodAAtx
 *
 * C source code generated by m2c.
 * %#m2c options:08e6d2d6ca13bacae4da25d349bd2072
 *
 */
...
static void __crs_prodAAtx_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            A;
    emxArray_real_T      x;
    emxArray_real_T      b;
    emxArray_real_T      Atx;
    ...
    copy_mxArray_to_emxArray(prhs[3], (emxArray__common *)(&Atx), "Atx", 2);
    ...
    if (mxGetNumberOfElements(prhs[4]) && mxGetDimensions(prhs[4])[1] != 1) 
        mexErrMsgIdAndTxt("crs_prodAAtx:WrongSizeOfInputArg",
            "Dimension 2 of nthreads should equal 1.");
    ...
    mxFree(b.size);
    plhs[1] = move_emxArray_to_mxArray((emxArray__common*)(&Atx), mxDOUBLE_CLASS);
    mxFree(Atx.size);
    free_emxArray((emxArray__common*)(&nthreads));

}

static void __crs_prodAAtx_ser_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            A;
    emxArray_real_T      x;
    emxArray_real_T      b;
...
static void __crs_prodAAtx_ser1_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            A;
    emxArray_real_T      x;
    emxArray_real_T      b;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 5) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("crs_prodAAtx:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_prodAAtx.\n");
        /* Call the API function. */
        __crs_prodAAtx_api(outputs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_prodAAtx_ser:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_prodAAtx_ser.\n");
        /* Call the API function. */
        __crs_prodAAtx_ser_api(outputs, prhs);
    }
    else if (nrhs == 3) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_prodAAtx_ser1:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_prodAAtx_ser1.\n");
        /* Call the API function. */
        __crs_prodAAtx_ser1_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("crs_prodAAtx:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point crs_prodAAtx.");
