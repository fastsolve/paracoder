/*
 * codegen/lib/crs_create/crs_create_mex.c
 *
 * Auxiliary code for mexFunction of crs_create
 *
 * C source code generated by m2c.
 * %#m2c options:8b590a496fd8e0a70e162c23055e6d58
 *
 */
...
static void __crs_create_api(mxArray **plhs, const mxArray ** prhs) {
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetDimensions(prhs[0])[1] != 1) 
        mexErrMsgIdAndTxt("crs_create:WrongSizeOfInputArg",
...
static void __crs_create0_api(mxArray **plhs, const mxArray ** prhs) {
    int32_T              ni;
    int32_T              nj;
    struct1_T            A;
    ...
    plhs[0] = marshallout_struct1_T(&A);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    if (nrhs == 3) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_create:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_create.\n");
        /* Call the API function. */
        __crs_create_api(plhs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_create0:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_create0.\n");
        /* Call the API function. */
        __crs_create0_api(plhs, prhs);
    }
    else if (nrhs == 5) {
        if (nlhs > 1)
        ...
        mexErrMsgIdAndTxt("crs_create:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point crs_create.");
}
