/*
 * crs/codegen/lib/crs_prodAx/crs_prodAx_mex.c
 *
 * Auxiliary code for mexFunction of crs_prodAx
 *
 * C source code generated by m2c.
 * %#m2c options:d7d392fcc35aa5d4abcee153c0678691
 *
 */
...
static void __crs_prodAx_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           A;
    emxArray_real_T      x;
    emxArray_real_T      b;
    int32_T              nthreads;
...
static void __crs_prodAx_ser_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           A;
    emxArray_real_T      x;
    emxArray_real_T      b;
...
static void __crs_prodAx_ser1_api(mxArray **plhs, const mxArray ** prhs) {
    CRS_Matrix           A;
    emxArray_real_T      x;
    emxArray_real_T      b;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    if (nrhs == 4) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_prodAx:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_prodAx.\n");
        /* Call the API function. */
        __crs_prodAx_api(plhs, prhs);
    }
    else if (nrhs == 2) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_prodAx_ser:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_prodAx_ser.\n");
        /* Call the API function. */
        __crs_prodAx_ser_api(plhs, prhs);
    }
    else if (nrhs == 3) {
        if (nlhs > 1)
            mexErrMsgIdAndTxt("crs_prodAx_ser1:TooManyOutputArguments",
                "Too many output arguments for entry-point crs_prodAx_ser1.\n");
        /* Call the API function. */
        __crs_prodAx_ser1_api(plhs, prhs);
    }
    else
        mexErrMsgIdAndTxt("crs_prodAx:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point crs_prodAx.");
}
