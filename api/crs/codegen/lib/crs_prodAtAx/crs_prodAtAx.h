...
extern void crs_prodAtAx(const struct0_T *A, const emxArray_real_T *x,
  emxArray_real_T *b, emxArray_real_T *Ax, const emxArray_int32_T *nthreads);
extern void crs_prodAtAx_initialize(void);
extern void crs_prodAtAx_ser(const struct0_T *A, const emxArray_real_T *x,
  emxArray_real_T *b);
extern void crs_prodAtAx_ser1(const struct0_T *A, const emxArray_real_T *x,
  emxArray_real_T *b);
