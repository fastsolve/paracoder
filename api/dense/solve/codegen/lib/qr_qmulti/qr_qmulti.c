...
void qr_qmulti(const emxArray_real_T *A, emxArray_real_T *bs, int ncols,
               const emxArray_real_T *V)
{
  ...
  for (u0 = ncols; u0 >= 1; u0--) {
    ...
    for (input_sizes_idx_0 = 0; input_sizes_idx_0 < i; input_sizes_idx_0++) {
      t2 = v1 * bs->data[(u0 + bs->size[0] * input_sizes_idx_0) - 1];
      i1 = u0 + 1;
      for (sizes_idx_0 = i1; sizes_idx_0 <= nrows; sizes_idx_0++) {
        t2 += A->data[(sizes_idx_0 + A->size[0] * (u0 - 1)) - 1] *
              bs->data[(sizes_idx_0 + bs->size[0] * input_sizes_idx_0) - 1];
      }
      t2 += t2;
      bs->data[(u0 + bs->size[0] * input_sizes_idx_0) - 1] -= t2 * v1;
      for (sizes_idx_0 = i1; sizes_idx_0 <= nrows; sizes_idx_0++) {
        bs->data[(sizes_idx_0 + bs->size[0] * input_sizes_idx_0) - 1] -=
            t2 * A->data[(sizes_idx_0 + A->size[0] * (u0 - 1)) - 1];
      }
