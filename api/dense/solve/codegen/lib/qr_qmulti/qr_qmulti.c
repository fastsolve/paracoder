...
void qr_qmulti_2args(const emxArray_real_T *A, emxArray_real_T *bs)
{
  int nrows;
  int u0;
  int ncols;
  ...
  for (u0 = ncols; u0 >= 1; u0--) {
    ...
    {
      t2_tmp = A->data[(input_sizes_idx_0 + A->size[0] * (u0 - 1)) - 1];
      v1 -= t2_tmp * t2_tmp;
    }
    ...
    for (sizes_idx_0 = 0; sizes_idx_0 < i; sizes_idx_0++) {
      t2_tmp = bs->data[(u0 + bs->size[0] * sizes_idx_0) - 1];
      t2 = v1 * t2_tmp;
      i1 = u0 + 1;
      for (input_sizes_idx_0 = i1; input_sizes_idx_0 <= nrows; input_sizes_idx_0
           ++) {
        t2 += A->data[(input_sizes_idx_0 + A->size[0] * (u0 - 1)) - 1] *
          bs->data[(input_sizes_idx_0 + bs->size[0] * sizes_idx_0) - 1];
      }

      t2 += t2;
      bs->data[(u0 + bs->size[0] * sizes_idx_0) - 1] = t2_tmp - t2 * v1;
      i1 = u0 + 1;
      for (input_sizes_idx_0 = i1; input_sizes_idx_0 <= nrows; input_sizes_idx_0
           ++) {
        bs->data[(input_sizes_idx_0 + bs->size[0] * sizes_idx_0) - 1] -= t2 *
          A->data[(input_sizes_idx_0 + A->size[0] * (u0 - 1)) - 1];
      }
    }
  }
...
void qr_qmulti_3args(const emxArray_real_T *A, emxArray_real_T *bs, int ncols)
{
  int nrows;
  emxArray_real_T *b_bs;
  int u0;
