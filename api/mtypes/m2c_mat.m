function type = m2c_mat(maxrow, maxcol, varrow, varcol) %#codegen
% Specifies a real (double-precision) matrix.
%    m2c_mat specifies a variable-size matrix.
%
%    m2c_mat(m, n) specifies fixed-size m-by-n matrix when m and n 
%    are both constants. Use inf for either m or n to specify a
%    variable dimension without upper bound.
%
%    m2c_mat(m, n, varrow, varcol) specifies variable-size m-by-n
%    with upper bound of sizes. Set varrow and varcol to false if
%    the row or column has varible sizes, respectively.
%
% See also m2c_vec, m2c_intmat, m2c_intvec, m2c_string
