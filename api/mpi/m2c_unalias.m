function [var1, var2, var3, var4, var5, var6, var7, var8, var9, var10] = ...
    m2c_unalias(var1, var2, var3, var4, ...
    var5, var6, var7, var8, var9, var10) %#codegen
%m2c_unalias  Prevents the given variable being an alias of another variable.
%
%   [var1, var2, ...] = m2c_unalias(var1, var2, ...) ensures the variables
%   are not aliass of other variables. It is important that all the input 
%   variables are listed as output variables.
%
% Example: [var1, var2] = m2c_unalias(var1, var2)
