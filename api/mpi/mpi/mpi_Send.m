function [info, toplevel] = mpi_Send(ptr, count, datatype, dest, tag, comm)
%mpi_Send	Performs a blocking send
%
%  info = mpi_Send(ptr, count, datatype, dest, tag, comm)
%
...
info = coder.ceval('MPI_Send', m2c_opaque_ptr_const(ptr), int32(count), ...
