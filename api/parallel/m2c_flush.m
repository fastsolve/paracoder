function m2c_flush(varargin) %#codegen
%Specifies that all threads have the same view of memory
...
% For CUDA, all the global memory is flushed.
%
% This directive specifies a "cross-thread" sequence point at which the
% implementation is required to ensure that all threads in a team/block 
% have a consistent view of certain objects (specified below) in memory.
...
%
% A flush directive without a variable-list is implied by m2c_barrier.
