...
static void m2c_error(const emxArray_char_T *varargin_3)
{
  ...
  M2C_error("CUDA:RuntimeError",
            "cudaThreadSynchronize returned error code %s\n",
            &b_varargin_3->data[0]);
  emxFree_char_T(&b_varargin_3);
}

void cuThreadSynchronize(int *errCode, boolean_T *toplevel)
{
...
void cuThreadSynchronize_initialize(void)
{
}

void cuThreadSynchronize_terminate(void)
{
}
