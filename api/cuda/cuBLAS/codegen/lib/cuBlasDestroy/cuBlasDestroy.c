...
void cuBlasDestroy(const struct0_T *hdl, int *errCode, boolean_T *toplevel)
{
  boolean_T p;
  boolean_T b_p;
  int k;
...
void cuBlasDestroy_initialize(void)
{
}
