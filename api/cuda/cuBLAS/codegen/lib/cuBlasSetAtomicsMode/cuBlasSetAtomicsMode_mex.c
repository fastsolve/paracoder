/*
 * cuBlasSetAtomicsMode_mex.c
 *
 * Auxiliary code for mexFunction of cuBlasSetAtomicsMode
 *
 * C source code generated by m2c.
 * %#m2c options:183c385932859d69414364b023150bd3
 *
 */
...
static void __cuBlasSetAtomicsMode_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            hdl;
    int32_T              mode;
    int32_T             *errCode;
    boolean_T           *toplevel;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("cuBlasSetAtomicsMode:WrongInputType",
            "Input argument hdl has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("cuBlasSetAtomicsMode:WrongSizeOfInputArg",
            "Argument hdl should be a scalar.");
    marshallin_const_struct0_T(&hdl, prhs[0], "hdl");

    if (mxGetNumberOfElements(prhs[1]) && mxGetClassID(prhs[1]) != mxINT32_CLASS)
        mexErrMsgIdAndTxt("cuBlasSetAtomicsMode:WrongInputType",
            "Input argument mode has incorrect data type; int32 is expected.");
    if (mxGetNumberOfElements(prhs[1]) != 1)
        mexErrMsgIdAndTxt("cuBlasSetAtomicsMode:WrongSizeOfInputArg",
            "Argument mode should be a scalar.");
    mode = *(int32_T*)mxGetData(prhs[1]);
    ...
    cuBlasSetAtomicsMode(&hdl, mode, errCode, toplevel);

    /* Deallocate input and marshall out function outputs */
    destroy_struct0_T(&hdl);
    /* Nothing to be done for mode */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 2) {
        if (nlhs > 2)
            mexErrMsgIdAndTxt("cuBlasSetAtomicsMode:TooManyOutputArguments",
                "Too many output arguments for entry-point cuBlasSetAtomicsMode.\n");
        /* Call the API function. */
        __cuBlasSetAtomicsMode_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("cuBlasSetAtomicsMode:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point cuBlasSetAtomicsMode.");
