...
static void __cuBlasGetPointerMode_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            hdl;
    int32_T             *mode;
    int32_T             *errCode;
    boolean_T           *toplevel;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("cuBlasGetPointerMode:TooManyOutputArguments",
                "Too many output arguments for entry-point cuBlasGetPointerMode.\n");
        /* Call the API function. */
        __cuBlasGetPointerMode_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("cuBlasGetPointerMode:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point cuBlasGetPointerMode.");
