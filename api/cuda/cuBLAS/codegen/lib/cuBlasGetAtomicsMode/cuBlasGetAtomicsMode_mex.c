/*
 * cuBlasGetAtomicsMode_mex.c
 *
 * Auxiliary code for mexFunction of cuBlasGetAtomicsMode
 *
 * C source code generated by m2c.
 * %#m2c options:50b40146a0a6dbd1bba6e01a2246ad0a
 *
 */
...
static void __cuBlasGetAtomicsMode_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            hdl;
    int32_T             *mode;
    int32_T             *errCode;
    boolean_T           *toplevel;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("cuBlasGetAtomicsMode:WrongInputType",
            "Input argument hdl has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("cuBlasGetAtomicsMode:WrongSizeOfInputArg",
            "Argument hdl should be a scalar.");
    marshallin_const_struct0_T(&hdl, prhs[0], "hdl");

    mode = mxMalloc(sizeof(int32_T));
    ...
    cuBlasGetAtomicsMode(&hdl, mode, errCode, toplevel);

    /* Deallocate input and marshall out function outputs */
    destroy_struct0_T(&hdl);
    plhs[0] = move_scalar_to_mxArray(mode, mxINT32_CLASS);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 1) {
        if (nlhs > 3)
            mexErrMsgIdAndTxt("cuBlasGetAtomicsMode:TooManyOutputArguments",
                "Too many output arguments for entry-point cuBlasGetAtomicsMode.\n");
        /* Call the API function. */
        __cuBlasGetAtomicsMode_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("cuBlasGetAtomicsMode:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point cuBlasGetAtomicsMode.");
