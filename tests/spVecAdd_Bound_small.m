...
%! 
%! m2c -force -O3 -mex tests/spVecAdd_Bound_small
%! z = spVecAdd_Bound_small(x, y, z);
%! assert(all(z.vals==2));

% %!test
% %! m2c -remove-emx -force -O3 -mex tests/spVecAdd_Bound_small
% %! z = spVecAdd_Bound_small(x, y, z);
% %! assert(all(z.vals==2));

%!test
%! m2c -omp -force -O3 -mex tests/spVecAdd_Bound_small
%! z = spVecAdd_Bound_small(x, y, z);
%! assert(all(z.vals==2));

% %!test
% %! m2c -nvcc -force -O3 -mex tests/spVecAdd_Bound_small
% %! z = spVecAdd_Bound_small(x, y, z);
% %! assert(all(z.vals==2));

% %!test
% %! m2c -remove-emx -nvcc -force -O3 -mex tests/spVecAdd_Bound_small
% %! z = spVecAdd_Bound_small(x, y, z);
% %! assert(all(z.vals==2));
