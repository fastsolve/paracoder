...
if hascodegen
    ...
    co_cfg.CustomSourceCode = sprintf('%s\n', ...
        ...
        'm2cErrMsgIdAndTxt("m2c_opaque_ptr:ParentObjectChanged", \', ...
        '"The parent mxArray has changed. Avoid changing a MATLAB variable when dereferenced by an m2c_opaque_ptr."');
