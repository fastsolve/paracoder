function lib2mex_exe(funcname, ldflags, opflags, args, buildexe, libs)
...
if nargin<5; buildexe = false; end
if nargin<6; libs = ''; end
...
print_README(outdir, funcname);
    ...
    function writeMexScript(outMfile, rtCfiles, opts)
        ...
        fprintf( fid, '%s\n', ...
            ...
            ' ''' funcname '_mex.' suf rtCfiles ' '' output '' ' mexdir funcname ' '' '  opts mpildflag ompldflag libs '];'], ...
            '    fprintf(''Entering %s\n'', pwd);', ...
            '    disp(cmd);', ...
            '    eval(cmd);', ...
    ...
    function writeExeScript(outMfile, opts)        
        ...
        fprintf( fid, '%s\n', ...
            ...
            ' ''' funcname '_exe.' suf ' -o ' exedir funcname '.exe '' '  opts libs mpildflag ompldflag ' matlibs];'], ...
            '    fprintf(''Entering %s\n'', pwd);', ...
            '    disp(cmd);', ...
            '    unix(cmd);', ...
