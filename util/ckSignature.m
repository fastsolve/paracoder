...
switch stage
    case 'codegen'
        fields = {'codegenArgs', 'codegenConfig', 'api', 'debugInfo', ...
            'enableInline', 'enableInf', 'timing', 'withMPI', 'withLapack', 'withPetsc'};
    case 'mex'
        fields = {'debugInfo', 'verbose', 'quiet', 'optLevel', ...
            'cc', 'cppflags', 'cflags', 'ldflags', 'libs', 'mexflags', 'mexDir', ...
            'withOMP', 'withACC', 'ompLibs', 'accLibs', 'mpiLibs', ...
            'lapackLibs', 'blasLibs', 'petscDir', 'cudaDir'};
    case 'exe'
        fields = {'debugInfo', 'verbose', 'quiet', 'optLevel', ...
            'cc', 'cppflags', 'cflags', 'ldflags', 'libs', 'exeDir', ...
            'withOMP', 'withACC', 'ompLibs', 'accLibs', 'mpiLibs', ...
            'lapackLibs', 'blasLibs', 'petscDir', 'cudaDir', ...
